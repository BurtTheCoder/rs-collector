...
mod tests {
    ...
    fn test_parse_unix_env_vars_dollar_style() {
        ...
        assert_eq!(parse_unix_env_vars("$HOME/Documents"), "/home/user/Documents");
    ...
    fn test_parse_unix_env_vars_brace_style() {
        ...
        assert_eq!(parse_unix_env_vars("prefix-${MYVAR}-suffix"), "prefix-myvalue-suffix");
    ...
    fn test_parse_unix_env_vars_nonexistent() {
        ...
        assert_eq!(parse_unix_env_vars("$DOESNOTEXIST/path"), "$DOESNOTEXIST/path");
    }
    ...
    fn test_normalize_path_for_os() {
        ...
        if cfg!(windows) {
            ...
            assert_eq!(normalize_path_for_os("mixed/path\\style"), "mixed\\path\\style");
        } else {
    ...
    fn test_normalize_path_empty_and_special() {
        ...
        assert_eq!(normalize_path_for_os("/"), "/");
        assert_eq!(normalize_path_for_os("\\"), if cfg!(windows) { "\\" } else { "/" });
