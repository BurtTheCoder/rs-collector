...
mod tests {
    ...
    fn test_windows_collector_clone() {
        ...
        assert_eq!(
            collector1
                .supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::Registry)),
            collector2
                .supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::Registry))
        );
    }
    ...
    fn test_supports_artifact_type() {
        ...
        assert!(collector.supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::MFT)));
        assert!(
            collector.supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::Registry))
        );
        assert!(
            collector.supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::EventLog))
        );
        assert!(
            collector.supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::Prefetch))
        );
        assert!(collector
            .supports_artifact_type(&ArtifactType::Windows(WindowsArtifactType::USNJournal)));
        ...
        assert!(!collector.supports_artifact_type(&ArtifactType::MacOS(
