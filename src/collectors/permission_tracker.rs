...
impl PermissionTracker {
    ...
    pub async fn report_failures(&self) {
        ...
        warn!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        warn!("");
        warn!("The following {} artifact(s) could not be collected due to insufficient permissions:", failures.len());
        warn!("");
        ...
        #[cfg(target_os = "linux")]
        {
            warn!("  1. Run with sudo: sudo {}", std::env::args().collect::<Vec<_>>().join(" "));
...
mod tests {
    ...
    fn test_permission_error_detection() {
        assert!(PermissionTracker::is_permission_error("Permission denied accessing file"));
        assert!(PermissionTracker::is_permission_error("Error: PermissionDenied"));
        assert!(PermissionTracker::is_permission_error("Access is denied"));
        assert!(PermissionTracker::is_permission_error("Try running with elevated privileges"));
